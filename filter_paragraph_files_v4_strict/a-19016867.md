...
What is the goal of the paper discussing the adaptive potential of salmonine fishes to anthropogenic disturbances, and which genetic parameters are reviewed?

Human judge: MAYBE

The contents are fine except the last sentence. The last sentence is not objectively related to the background, nor supported by any reference. It is due to the nature of the introduction section, which is not a problem per se. However, the last sentence is confusing when we convert this paragraph to an answer.