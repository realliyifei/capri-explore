...
Villalón et al., 2020 [42] This review revealed that predictive control approaches are used on microgrids for the three control levels and with model modifications to account for uncertainties in order to enhance performance and dynamic response.For microgrid applications requiring various degrees of control, predictive control appears to be a very promising control strategy.
...
Papers on the "complexity" on microgrid systems [46-50]; • Papers on the "uncertainty" in microgrid systems[51-62]; • Papers on "forecasting" on microgrid systems [44,60,63-76].
...
A centralized energy management system for isolated microgrids. D E Olivares, C A Cañizares, M Kazerani, IEEE Trans. Smart Grid. 52014
...
Recent advances on Microgrid Structure and Control Strategy. Y Zhang, M Fei, D Du, A Rakić, Proceedings of the 2021 40th Chinese Control Conference (CCC). the 2021 40th Chinese Control Conference (CCC)Shanghai, ChinaJuly 2021
...
Systematic review on model predictive control strategies applied to active thermal energy storage systems. J Tarragona, A L Pisello, C Fernández, A De Gracia, L F Cabeza, Renew. Sustain. Energy Rev. 1113852021

Predictive control for microgrid applications: A review study. Energies. A Villalón, M Rivera, Y Salgueiro, J Muñoz, T Dragičević, F Blaabjerg, 2020132454
...
Modular hierarchical model predictive control for coordinated and holistic energy management of buildings. M Vašak, A Banjac, N Hure, H Novak, D Marušić, V Lešić, IEEE Trans. Energy Convers. 362021
...
Cooperative optimization of networked microgrids for supporting grid flexibility services using model predictive control. F Garcia-Torres, P Báez-Gonzalez, J Tobajas, F Vazquez, E Nieto, IEEE Trans. Smart Grid. 122020
...
Resilience-oriented schedule of microgrids with hybrid energy storage system using model predictive control. J Tobajas, F Garcia-Torres, P Roncero-Sánchez, J Vázquez, L Bellatreche, E Nieto, Appl. Energy. 1180922022
...
Hierarchical distributed model predictive control of interconnected microgrids. C A Hans, P Braun, J Raisch, L Grüne, C Reincke-Collon, IEEE Trans. Sustain. Energy. 102018
...
Hierarchical distributed ADMM for predictive control with applications in power networks. P Braun, T Faulwasser, L Grüne, C M Kellett, S R Weller, K Worthmann, IFAC J. Syst. Control. 32018
...
Distributed control strategies for microgrids: An overview. E Espina, J Llanos, C Burgos-Mellado, R Cardenas-Dobson, M Martinez-Gomez, D Sáez, IEEE Access. 82020
...
Multi-agent control strategy for microgrids using petri nets. H R Chamorro, C Pazmino, D Paez, F Jiménez, J M Guerrero, V K Sood, W Martinez, Proceedings of the 2020 IEEE 29th International Symposium on Industrial Electronics (ISIE). the 2020 IEEE 29th International Symposium on Industrial Electronics (ISIE)Delft, The NetherlandsJune 2020

Multi agent system solution to microgrid implementation. S Boudoudouh, M Maâroufi, Sustain. Cities Soc. 392018
...
Energy management in microgrids with renewable energy sources: A literature review. García Vera, Y E Dufo-López, R Bernal-Agustín, J L , Appl. Sci. 938542019
...
Cloud and machine learning experiments applied to the energy management in a microgrid cluster. D Rosero, N Díaz, C Trujillo, Appl. Energy. 3041177702021
...
Hierarchical energy management system for microgrid operation based on Robust model predictive control. Energies. L G Marín, M Sumner, D Muñoz-Carpintero, D Köbrich, S Pholboon, D Sáez, A Núñez, 2019124453
...
An Analysis of Energy Storage System Interaction in A Multi Objective Model Predictive Control Based Energy Management in DC microgrid. U R Nair, R Costa-Castelló, Proceedings of the 2019 24th IEEE International Conference on Emerging Technologies and Factory Automation (ETFA). the 2019 24th IEEE International Conference on Emerging Technologies and Factory Automation (ETFA)Zaragoza, Spain10-13 September 2019
...
Model predictive control of DC-DC converters to mitigate the effects of pulsed power loads in naval DC microgrids. M M Mardani, M H Khooban, A Masoudian, T Dragičević, IEEE Trans. Ind. Electron. 662018
...
Reinforcement learning for demand response: A review of algorithms and modeling techniques. J R Vázquez-Canteli, Z Nagy, Appl. Energy. 2352019
...
A rolling horizon optimization framework for the simultaneous energy supply and demand planning in microgrids. J Silvente, G M Kopanos, E N Pistikopoulos, A Espuña, Appl. Energy. 1552015
...
Optimization Models under Uncertainty in Distributed Generation Systems: A Review. À Alonso-Travesset, H Martín, S Coronas, J De La Hoz, 2022. 193215

Towards optimal management in Microgrids: An overview. Energies. T Á O Gavilema, J D Álvarez, J L Torres Moreno, M P García, 2021145202
...
Energy management systems for microgrids: Main existing trends in centralized control architectures. Energies. D Espín-Sarzosa, R Palma-Behnke, O Núñez-Mata, 202013547
