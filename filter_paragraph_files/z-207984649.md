...
## (s16) Significance of maize variety type used to closing yield gaps
(p16.0) The type of seed/variety grown remarkably influenced maize grain yield (Enujeke, 2013). The type of maize variety used can explain up to 20% of maize yield gap, signifying that the use of the appropriate variety is one  way to improve maize grain yields (Ghimire et al., 2016) and thus close maize yield gaps.
